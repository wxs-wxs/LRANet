...
num_coefficients = 28 # 每个文本预测720个点
path_lra = './eigenanchors/pca_28.npz'  #'./eigenanchors/lra_totaltext_14.npz'
...
train_pipeline = [
    ...
    dict(
        type='LRATargetsNew',
        level_proportion_range=((0, 0), (0, 0), (0.0, 1.0)),
        with_area=True,
        path_lra=path_lra,
        num_coefficients=num_coefficients,
        num_samples=3,
